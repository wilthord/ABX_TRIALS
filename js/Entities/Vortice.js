VorticeClass = function(enemyJson){
...
VorticeClass.prototype = Object.create(EntityClass.prototype);

VorticeClass.prototype.constructor = VorticeClass;

VorticeClass.prototype.update = function(){
...
VorticeClass.prototype.onTouch = function(otherBody, point, impulse){
